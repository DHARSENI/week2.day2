...
public class EditElement {
	public static void main(String[] args) {
		WebDriverManager.chromedriver().setup(); 
		 ...
		 if (eletext1==true) {
			 driver.findElement(By.id("email")).sendKeys("selva@gmail.com");
		}
		 
		 Boolean eletext= driver.findElement(By.xpath("//input[@value='Append ']")).isEnabled();
		 if (eletext==true) {
			 driver.findElement(By.xpath("//input[@value='Append ']")).sendKeys("Welcome");
		}
		 String strValue= driver.findElement(By.xpath("//input[@value='Selenium']")).getAttribute("value");
